...
type Section = 'overview' | 'catalogue' | 'campaigns' | 'approvals' | 'inspections' | 'gallery' | 'fieldforce' | 'models' | 'team' | 'architecture' | 'dealerships';
...
const sections: Array<{ id: Section; label: string; icon: string; capability?: string }> = [
  ...
  { id: 'fieldforce', label: 'Field force', icon: '⌖', capability: 'view_sales_officer_activity' },
  { id: 'dealerships', label: 'Dealerships', icon: '🏪', capability: 'view_sales_officer_activity' },
