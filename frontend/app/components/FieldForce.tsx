...
type Officer = {
  ...
  day_distinct_crops: number; day_distinct_problems: number; day_quality_eligible: number; day_gemini_fallback: number;
...
export default function FieldForce({ initialData, canManage = false }: { initialData?: Report; canManage?: boolean }) {
  ...
  useEffect(()=>setPage(1),[state,territory,mode,sort,query,pageSize]);
